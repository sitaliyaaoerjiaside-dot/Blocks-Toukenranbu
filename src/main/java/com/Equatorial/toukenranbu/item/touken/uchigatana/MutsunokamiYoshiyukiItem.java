...
public class MutsunokamiYoshiyukiItem extends Item {

    public MutsunokamiYoshiyukiItem(Properties properties) {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (!level.isClientSide && context.getPlayer() != null) {
            ...
            MutsunokamiYoshiyukiEntity danshi = new MutsunokamiYoshiyukiEntity(ModEntityTypes.MUTSUNOKAMI_YOSHIYUKI.get(), level);
            danshi.setTame(true);
            ...
            context.getPlayer().sendSystemMessage(
                    Component.translatable("message.toukenranbu_mod.summon_mutsunokami_yoshiyuki")
            );
        }
