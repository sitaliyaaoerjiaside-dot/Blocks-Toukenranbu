...
public class KasenKanesadaItem extends Item {

    public KasenKanesadaItem(Properties properties) {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (!level.isClientSide && context.getPlayer() != null) {
            ...
            KasenKanesadaEntity danshi = new KasenKanesadaEntity(ModEntityTypes.KASEN_KANESADA.get(), level);
            danshi.setTame(true);
            ...
            context.getPlayer().sendSystemMessage(
                    Component.translatable("message.toukenranbu_mod.summon_kasen_kanesada")
            );
        }
