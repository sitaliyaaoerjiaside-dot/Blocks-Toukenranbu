...
public class KashuuKiyomitsuItem extends Item {

    public KashuuKiyomitsuItem(Properties properties) {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (!level.isClientSide && context.getPlayer() != null) {
            ...
            KashuuKiyomitsuEntity danshi = new KashuuKiyomitsuEntity(ModEntityTypes.KASHUU_KIYOMITSU.get(), level);
            danshi.setTame(true);
            ...
            context.getPlayer().sendSystemMessage(
                    Component.translatable("message.toukenranbu_mod.summon_kashuu_kiyomitsu")
            );
        }
