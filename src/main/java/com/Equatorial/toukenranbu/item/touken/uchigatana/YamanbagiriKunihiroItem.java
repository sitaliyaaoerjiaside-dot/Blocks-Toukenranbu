...
public class YamanbagiriKunihiroItem extends Item {

    public YamanbagiriKunihiroItem(Properties properties) {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (!level.isClientSide && context.getPlayer() != null) {
            ...
            YamanbagiriKunihiroEntity danshi = new YamanbagiriKunihiroEntity(ModEntityTypes.YAMANBAGIRI_KUNIHIRO.get(), level);
            danshi.setTame(true);
            ...
            context.getPlayer().sendSystemMessage(
                    Component.translatable("message.toukenranbu_mod.summon_yamanbagiri_kunihiro")
            );
        }
